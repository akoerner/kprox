    ...
    while (pos < (int)text.length() && !g_parserAbort) {
        ...
        if (isKeyToken(u.substring(0, u.indexOf(' ') >= 0 ? u.indexOf(' ') : u.length()))) {
            ...
            static const std::vector<Setting> SETTINGS = {
                ...
                { "bt.consumer",          []{ return String(bleConsumerEnabled ? 1 : 0); },
                                          [](String v){ bleConsumerEnabled = (v == "1" || v == "true"); saveBtSettings(); return true; } },
                { "bt.system",            []{ return String(bleSystemEnabled ? 1 : 0); },
                                          [](String v){ bleSystemEnabled = (v == "1" || v == "true"); saveBtSettings(); return true; } },
#ifdef BOARD_HAS_USB_HID
                ...
                { "usb.consumer",         []{ return String(usbConsumerEnabled ? 1 : 0); },
                                          [](String v){ usbConsumerEnabled = (v == "1" || v == "true"); saveUSBSettings(); return true; } },
                { "usb.system",           []{ return String(usbSystemEnabled ? 1 : 0); },
                                          [](String v){ usbSystemEnabled = (v == "1" || v == "true"); saveUSBSettings(); return true; } },
